...
A file-backed kanban page for work items stored under `workitems/`. Requires QiushuiAI `>=1.8.0`.

## Install

Open **Settings → Add-Ons** and install **kanban-board-widget** from the catalog, then reload QiushuiAI.
