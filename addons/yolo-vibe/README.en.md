# @qiushuiai/qiushuiai-addon-yolo-vibe

Quick compose-box YOLO buttons for the QiushuiAI web UI.
...
- Uses `mode: "auto"`, so QiushuiAI decides whether to send immediately or queue behind an active run.
