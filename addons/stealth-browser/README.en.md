...
Human-like browser automation backed by `@mochi.js/core`. Requires QiushuiAI `>=2.0.0`.
...
|---|---|---|
| `QIUSHUIAI_STEALTH_SEED` | Stable fingerprint seed | hostname |
| `QIUSHUIAI_STEALTH_PROFILE` | Explicit Mochi profile | auto-detected |
| `QIUSHUIAI_STEALTH_PROXY` | Proxy URL | none |
| `QIUSHUIAI_STEALTH_HEADLESS` | Headless mode | `true` |
