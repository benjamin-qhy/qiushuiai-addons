...
export class PortainerClient {
  ...
  async execContainer(endpointId: number, containerId: string, input: { command: string; command_args?: string[]; shell_family?: "posix" | "powershell" }): Promise<Record<string, unknown>> {
