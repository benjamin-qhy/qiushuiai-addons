# @qiushuiai/qiushuiai-addon-editable-table

Editable Markdown table widget for the QiushuiAI web UI.
...
`editable_table` requires the interactive QiushuiAI web UI and opens a floating widget. Parameters include the Markdown `table` plus optional `title` and `instructions`. Without an interactive UI, the tool returns an explicit requirement error.
