...
// Inline helper: replaces src/utils/path-safety.ts stripBaseDirForDisplay
function stripBaseDirForDisplay(baseDir: string, absolutePath: string): string {
  if (!absolutePath.startsWith(baseDir)) return absolutePath;
