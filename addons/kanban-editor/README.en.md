# @qiushuiai/qiushuiai-addon-kanban-editor

Workspace `.kanban.md` editor add-on for qiushuiai.
...
- takes over `.kanban.md` handling through the `kanban-editor` workspace pane; QiushuiAI core no longer ships a built-in kanban pane
...
- qiushuiai core no longer registers or ships the built-in kanban pane/runtime assets
...
The kanban board UI is now fully carved out of qiushuiai core and lives in this add-on.
