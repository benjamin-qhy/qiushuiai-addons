...
/**
 * Try to resolve qiushuiai's runtime KV store through the supported runtime bridge.
 * Do not import qiushuiai runtime internals from add-ons; standalone/test runs use
