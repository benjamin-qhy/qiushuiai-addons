 ...
 *
 * This file registers no tools. It provides the transport, authentication, browser
 * automation, and file-sharing plumbing used by the standalone add-on entry point.
 *
...
const log = createLogger("addon.m365.shared");
