...
A roll-down dashboard for recent QiushuiAI sessions. Requires QiushuiAI `>=2.0.0`.

## Install

Open **Settings → Add-Ons** and install **session-dashboard** from the catalog, then reload QiushuiAI.
...
Click a tile to switch through QiushuiAI's in-app navigation. Ctrl/Cmd-click opens the session in a new tab.
