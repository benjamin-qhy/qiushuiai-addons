...
test("derives reported and non-reasoning throughput from authoritative intervals", () => {
  ...
  expect(buildModelSpeedSpanAttributes(telemetry)).toMatchObject({
    "qiushuiai.model.call_duration_ms": 2_000,
    "qiushuiai.model.response_duration_ms": 1_600,
    "qiushuiai.model.response_start_latency_ms": 400,
    "qiushuiai.model.time_to_first_output_ms": 600,
    "qiushuiai.model.time_to_first_text_ms": 1_000,
    "qiushuiai.model.generation_duration_ms": 1_300,
    "qiushuiai.model.text_generation_duration_ms": 800,
    "qiushuiai.model.output_tokens_per_second": 50,
    "qiushuiai.model.non_reasoning_output_tokens_per_second": 25,
    "qiushuiai.model.reasoning_tokens": 40,
  });
});
...
test("omits unsupported rates and accepts legacy duration and usage field names", () => {
  ...
  expect(buildModelSpeedSpanAttributes(telemetry)).not.toHaveProperty("qiushuiai.model.non_reasoning_output_tokens_per_second");
});
