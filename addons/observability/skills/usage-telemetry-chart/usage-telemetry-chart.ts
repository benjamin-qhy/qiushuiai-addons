...
const args = parseArgs({ options: { "render-url": { type: "string" }, prefix: { type: "string", default: "qiushuiai" }, metric: { type: "string", default: "tokens.total" }, days: { type: "string", default: "7" }, instance: { type: "string" }, provider: { type: "string" }, model: { type: "string" }, output: { type: "string" } } }).values;
